...
from typing import List, Optional, Sequence, Type, Tuple, TypeVar, cast
...
class ClosedFormIASolver(IASolverBaseClass):
    ...
    def _updateF(self, F0: Optional[np.ndarray] = None):
        """
        Find the precoders.
...
class IterativeIASolverBaseClass(IASolverBaseClass):
    ...
    def _solve_init(self, Ns: IntOrIntSequence, P: FloatOrFloatSequence):
        """
    ...
    def solve(self,
        ...
        self._Ns: Sequence[int] = np.array(Ns, dtype=int)
...
class MMSEIASolver(IterativeIASolverBaseClass):
    ...
    def _solve_init(self, Ns: IntOrIntSequence, P: np.ndarray):
        """
...
class BruteForceStreamIASolver:
    ...
    def __init__(self, iasolver_obj: IASolverBaseClass):
        ...
        self._stream_combinations: Sequence[int] = ()
